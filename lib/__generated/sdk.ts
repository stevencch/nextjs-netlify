...
/** [See type definition](https://app.contentful.com/spaces/7s5tqcx2j8zb/content_types/author) */
...
/** cw keys [See type definition](https://app.contentful.com/spaces/7s5tqcx2j8zb/content_types/cwrKey) */
export type CwrKey = Entry & _Node & {
  __typename?: 'CwrKey';
  _id: Scalars['ID']['output'];
  contentfulMetadata: ContentfulMetadata;
  key?: Maybe<Scalars['JSON']['output']>;
  linkedFrom?: Maybe<CwrKeyLinkingCollections>;
  name?: Maybe<Scalars['String']['output']>;
  sys: Sys;
};
...
/** cw keys [See type definition](https://app.contentful.com/spaces/7s5tqcx2j8zb/content_types/cwrKey) */
export type CwrKeyKeyArgs = {
  locale?: InputMaybe<Scalars['String']['input']>;
};


/** cw keys [See type definition](https://app.contentful.com/spaces/7s5tqcx2j8zb/content_types/cwrKey) */
export type CwrKeyLinkedFromArgs = {
  allowedLocales?: InputMaybe<Array<InputMaybe<Scalars['String']['input']>>>;
};


/** cw keys [See type definition](https://app.contentful.com/spaces/7s5tqcx2j8zb/content_types/cwrKey) */
export type CwrKeyNameArgs = {
  locale?: InputMaybe<Scalars['String']['input']>;
};

export type CwrKeyCollection = {
  __typename?: 'CwrKeyCollection';
  items: Array<Maybe<CwrKey>>;
  limit: Scalars['Int']['output'];
  skip: Scalars['Int']['output'];
  total: Scalars['Int']['output'];
};

export type CwrKeyFilter = {
  AND?: InputMaybe<Array<InputMaybe<CwrKeyFilter>>>;
  OR?: InputMaybe<Array<InputMaybe<CwrKeyFilter>>>;
  contentfulMetadata?: InputMaybe<ContentfulMetadataFilter>;
...
export type CwrKeyLinkingCollections = {
  __typename?: 'CwrKeyLinkingCollections';
  entryCollection?: Maybe<EntryCollection>;
};


export type CwrKeyLinkingCollectionsEntryCollectionArgs = {
  limit?: InputMaybe<Scalars['Int']['input']>;
  locale?: InputMaybe<Scalars['String']['input']>;
  preview?: InputMaybe<Scalars['Boolean']['input']>;
  skip?: InputMaybe<Scalars['Int']['input']>;
...
/** [See type definition](https://app.contentful.com/spaces/7s5tqcx2j8zb/content_types/post) */
...
export type Query = {
  ...
  authorCollection?: Maybe<AuthorCollection>;
  cwrKey?: Maybe<CwrKey>;
  cwrKeyCollection?: Maybe<CwrKeyCollection>;
  entryCollection?: Maybe<EntryCollection>;
  post?: Maybe<Post>;
  postCollection?: Maybe<PostCollection>;
};
...
export type QueryCwrKeyCollectionArgs = {
  limit?: InputMaybe<Scalars['Int']['input']>;
  locale?: InputMaybe<Scalars['String']['input']>;
  order?: InputMaybe<Array<InputMaybe<CwrKeyOrder>>>;
  preview?: InputMaybe<Scalars['Boolean']['input']>;
  skip?: InputMaybe<Scalars['Int']['input']>;
  where?: InputMaybe<CwrKeyFilter>;
};
